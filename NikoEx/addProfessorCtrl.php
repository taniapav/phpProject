  ...
  <div class="container mt-5 mb-5">
    <?php if (count($_POST) == 0 || count($formErrors) > 0) { ?>
      <form action="signin.php" method="POST">
        <fieldset>
          <legend class="text-center text-muted"><p class="bienV">BIENVENUE !<br>Inscrivez-vous</p></legend>
        ...
        <div class="col-lg-6 col-md-6 col-12">
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
              <label class="text-muted" for="mailConfirm">Confirmez votre dresse mail</label>
