...
?>
  ...
  <div class="pres">
    <div class="container">
     <div class="row">
      <div class="col-md-12">
          <h2 class="text-center text-muted">« LA SANTÉ C'EST CE QUE L'ON A DE PLUS PRÉCIEUX »</h3>
          <div class="row">
            <div class=" col-md-8 offset-2">
              <h3 class="text-muted">SÉLÉCTIONNEZ UN RDV</h3>
              <form class="kalendar" action="osteopath-calendar.php" method="POST">
                   ...
                   <input class="btnCalend" type="submit" value="Valider" />
                </form>
                <table>
                   <thead>
                      <tr>
                      ...
                      <tr>
                        ...
                        */
                            if ($td >= $firstWeekDayOfMonth && $currentDay <= $numberDayInMonth) {
                               ?>
                        <td><a href="add-appointment.php?date=<?= $yearSelected . '-' . $monthSelected . '-' . $currentDay ?>"><?= $currentDay ?></a></td>
                            <?php
                            $currentDay++;
