...
require_once 'controller/updateProfCtrl.php';
  ...
  <div class="container">
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td><i data-toggle="modal" data-target="#deleteProffesorModal" data-id="<?= $usersProfil->id; ?>" data-lastname="<?= $usersProfil->lastname ?>" data-firstname="<?= $usersProfil->firstname ?>" class="fas fa-trash text-primary"></i></td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="row">
          <div class="col-md-12">
            <form action="update-prof.php?id=<?php echo $users->id ?>" method="POST">
              <fieldset>
            ...
            -->
            <div class="modal fade" id="deleteProffesorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
